    ...
    describe("Example 1", () => {
      ...
      describe("Movement Variance row", () => {
        ...
        it("Renders the movement variance 1 field correctly", () => {
          expect(field.find("[data-test='movementVar1-0']").text()).toEqual("4");
        });

        it("Renders the movement variance 2 field correctly", () => {
          expect(field.find("[data-test='movementVar2-0']").text()).toEqual("3");
        });

        it("Renders the movement variance 3 field correctly", () => {
          expect(field.find("[data-test='movementVar3-0']").text()).toEqual("2");
        });

        it("Renders the movement variance 4 field correctly", () => {
          expect(field.find("[data-test='movementVar4-0']").text()).toEqual("1");
        });
