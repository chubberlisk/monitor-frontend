  ...
  describe("1 item", () => {
    ...
    describe("Example 2", () => {
      ...
      describe("Variance row", () => {
        ...
        it("Renders the variance 1 field correctly", () => {
          expect(field.find("[data-test='variance1-0']").text()).toEqual("324");
        });

        it("Renders the variance 2 field correctly", () => {
          expect(field.find("[data-test='variance2-0']").text()).toEqual("323");
        });

        it("Renders the variance 3 field correctly", () => {
          expect(field.find("[data-test='variance3-0']").text()).toEqual("322");
        });

        it("Renders the variance 4 field correctly", () => {
          expect(field.find("[data-test='variance4-0']").text()).toEqual("321");
        });
  ...
  describe("2 items", () => {
    ...
    describe("Example 2", () => {
      ...
      describe("Variance row 1", () => {
        ...
        it("Renders the variance 1 field correctly", () => {
          expect(field.find("[data-test='variance1-1']").text()).toEqual("324");
        });

        it("Renders the variance 2 field correctly", () => {
          expect(field.find("[data-test='variance2-1']").text()).toEqual("323");
        });

        it("Renders the variance 3 field correctly", () => {
          expect(field.find("[data-test='variance3-1']").text()).toEqual("322");
        });

        it("Renders the variance 4 field correctly", () => {
          expect(field.find("[data-test='variance4-1']").text()).toEqual("321");
        });
