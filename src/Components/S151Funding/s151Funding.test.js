  ...
  describe("Example 1", () => {
    ...
    describe("Baseline row", () => {
      ...
      it("Renders the period field correctly", () => {
        expect(field.find("[data-test='period']").text()).toEqual("2018/19");
      });

      it("Renders the baseline 1 field correctly", () => {
        expect(field.find("[data-test='baseline1']").text()).toEqual("1234");
      });

      it("Renders the baseline 2 field correctly", () => {
        expect(field.find("[data-test='baseline2']").text()).toEqual("5678");
      });

      it("Renders the baseline 3 field correctly", () => {
        expect(field.find("[data-test='baseline3']").text()).toEqual("9101");
      });

      it("Renders the baseline 4 field correctly", () => {
        expect(field.find("[data-test='baseline4']").text()).toEqual("4312");
      });

      it("Renders the total field correctly", () => {
        expect(field.find("[data-test='total']").text()).toEqual("12356789");
      });
    });
    ...
    describe("Variance row", () => {
      ...
      it("Renders the total field correctly", () => {
        expect(field.find("[data-test='varianceTotal']").text()).toEqual("1290");
      });
    });
    ...
    describe("Last Movement row", () => {
      ...
      it("Renders the total field correctly", () => {
        expect(field.find("[data-test='movementTotal']").text()).toEqual("10");
      });
    });

    describe("Movement Variance row", () => {
      it("Renders the movement variance row", () => {
        expect(field.find("[data-test='movementVariance']").length).toEqual(1);
      });

      it("Renders the movement variance 1 field correctly", () => {
        expect(field.find("[data-test='movementVar1']").text()).toEqual("4");
      });

      it("Renders the movement variance 2 field correctly", () => {
        expect(field.find("[data-test='movementVar2']").text()).toEqual("3");
      });

      it("Renders the movement variance 3 field correctly", () => {
        expect(field.find("[data-test='movementVar3']").text()).toEqual("2");
      });

      it("Renders the movement variance 4 field correctly", () => {
        expect(field.find("[data-test='movementVar4']").text()).toEqual("1");
      });

      it("Renders the total field correctly", () => {
        expect(field.find("[data-test='movementVarTotal']").text()).toEqual("10");
      });
    });
  });
});
